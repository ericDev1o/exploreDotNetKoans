...
public class AboutDecimals : Koan
{
	...
	public void DecimalsAndOtherFloatingPointTypesDoNotPlayNice()
	{
		...
		var result1 = 0m;
		var result2 = d + (decimal)db;
		result1 = d + (decimal)f;

		Assert.Equal(9.3m, result1);
		Assert.Equal(12.5m, result2);
	}
	...
	public void DecimalsHaveLimitedPrecision()
	{
		...
		Assert.Equal(1.0000000000000000000000000000m, twentyNineDigits); //.net 8.0.204 behavior
